...
The **Aldar Resale** source remains distinct from Aldar developer inventory. Developer inventory is shown in the Sales & Inventory Sync desk from `inventory_unit_state`, while Aldar resale represents curated resale records only.
