...
const communities = [
  ...
  {
    slug: "private-owners-vip",
    name: "Private Owners VIP",
    cluster: "Saadiyat Beach District · 7 official SDN3 DCR plots",
    plots: 7,
    href: "/private-owners-vip",
    available: true,
    rich: true,
  },
  {
    slug: "building-plots-sdw4",
    name: "Building Plots SDW4",
    cluster: "NYU Precinct · 26 official DCR plots",
    plots: 26,
    href: "/building-plots-sdw4",
    available: true,
    rich: true,
  },
  {
