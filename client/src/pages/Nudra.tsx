  ...
  return (
    <article id={`nudra-${unit.unitNumber}`} className="rounded-lg border border-border bg-card overflow-hidden shadow-sm flex flex-col">
      ...
      <div className="p-4 pt-0 flex flex-wrap gap-2">
        <Link href="/map?community=nudra" className="inline-flex items-center gap-1 rounded-md border border-border px-2.5 py-1.5 text-xs font-semibold text-foreground hover:bg-muted"><MapPin className="h-3.5 w-3.5" /> Project map</Link>
