/**
 * Golf Views Plot Land Areas & Transaction Matching
 * Extracted from DCR PDFs (plot area in sq.m converted to sqft)
 * Matched to ADREC SDN2 transactions by land area (±100 sqft tolerance)
 * 22 of 26 plots matched to transactions
 */
...
/** Map of villaKey -> plot data with land area and matched transactions */
