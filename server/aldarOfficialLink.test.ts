...
describe("official Aldar unit link validation", () => {
  ...
  it.each([
    ...
    ["al-ghadeer-gardens", "AlGhadeerGardens-N2-V-004-Test-01", "alghadeergardens", "N2-V-004-Test-01"],
    ["al-ghadeer-parks-1", "AlGhadeerParks1-NC-V-002-01", "alghadeerparks1", "NC-V-002-01"],
    ["al-ghadeer-parks-2", "AlGhadeerParks2-ND-TH-001-01", "alghadeerparks2", "ND-TH-001-01"],
