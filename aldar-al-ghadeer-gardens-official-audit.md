...
### ملف التفاصيل الكامل المرفوع — 3 سبتمبر 2026

تلقى النظام ملف `Aldar_Al_Ghadeer_Hero_Full_Complete.xlsx` كمرجع تفاصيل أحدث. يتضمن **1,243** سجل وحدة، بأسعار وحالة ومواصفات ومساحات وخطط دفع وأقساط وعروض. تمت مطابقة رمز الملف مع رمز World of Aldar الحالي بعد حذف لاحقة الطابق التقنية `-01` من رمز World of Aldar فقط: **1,243 من 1,243** تطابقًا، بلا رمز مكرر أو صف غير مطابق. التوزيع: Gardens عدد 790، Parks 1/NC عدد 280، وParks 2/ND عدد 173.

تُطبق هذه التفاصيل على الوحدة المطابقة وحدها وتبقى حالة الملف **حالة مصدر**، وليست NAS availability. لا تُنقل معرفات Salesforce أو رابط تفاصيل الـAPI الواردان في الملف إلى المتصفح. يحتفظ الالتقاط اليومي بهذه التفاصيل عندما لا تنشر صفحة World of Aldar حقولًا تجارية مقابلة.
